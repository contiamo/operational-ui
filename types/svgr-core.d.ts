declare module "@svgr/core" {
  ...
  function svgr(svgCode: string, config?: Partial<Config>, state?: Partial<State>): Promise<string>

  namespace svgr {
    function sync(svgCode: string, config?: Partial<Config>, state?: Partial<State>): string
  }
