...
export default () =>
  <div>
    ...
    <h2>Stats are little pieces of information that contain a descriptor and a value of the descriptor.</h2>

    <p>These elements are commonly used to represent KPI data, with strong key-value pairings.</p>
