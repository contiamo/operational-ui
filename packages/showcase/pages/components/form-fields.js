  ...
  <Layout pathname={props.url.pathname}>
    <Canvas>
      <Card>
        ...
        <p>
          The Fieldset component can be used to group multiple form elements, layout them out under a common legend.
          These fieldsets stay together when used in a multi-column layout.
        </p>
