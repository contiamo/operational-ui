...
var placeSingleSourceNodes = function (nodesInRow, nodePositions) {
...
var singleSourceAbove = function (sourcePositions) {
...
var isSourceDirectlyAbove = function (node, nodes) {
...
var xPositionAvailable = function (nodePositions) {
...
var shiftNodesToRight = function (x) {
...
var calculateXPosition = function (sourcePositions, possiblePositions) {
    var newColumn = false;
