...
var Layout = /** @class */ (function () {
    ...
    Layout.prototype.computeLayout = function () {
        var data = this.state.current.computed.series.data;
    ...
    Layout.prototype.computeNodeYPositions = function () {
        ...
        var i = 0;
        var that = this;
        function assignNextNodes(nodes) {
            nextNodes = [];
    ...
    Layout.prototype.isSourceDirectlyAbove = function (node) {
        ...
        return fp_1.bind(function (xValue) {
            ...
            var maxYVal = fp_1.flow(fp_1.filter(function (n) {
                return n.x === xValue;
            }), fp_1.reduce(function (max, n) {
    ...
    Layout.prototype.calculateXPosition = function (sourcePositions, possiblePositions) {
        ...
        if (possiblePositions.length > 0) {
            possiblePositions = fp_1.sortBy(function (x) {
    ...
    Layout.prototype.computeNodeXPositions = function () {
        var _this = this;
        var rows = fp_1.uniq(fp_1.sortBy(function (y) {
            return y;
        })(fp_1.map(function (node) {
            return node.y;
        })(this.nodes)));
        fp_1.forEach(function (row) {
            var nodesInRow = fp_1.filter(function (node) {
                return node.y === row;
            })(_this.nodes);
            if (row === 0) {
