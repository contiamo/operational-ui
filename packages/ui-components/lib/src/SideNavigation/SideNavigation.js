...
var SideNavigation = function (_a) {
    ...
    var backgroundColor = color
        ? contiamo_ui_utils_1.hexOrColor(color)(theme.colors ? theme.colors[color] : "white")
        : theme.colors && theme.colors.primary, hoverWidth = expandOnHover
        ? {
        ...
        : {};
    return __assign({ position: fix ? "fixed" : "relative", zIndex: (theme.baseZIndex || 0) + 100, display: "flex", flexDirection: "column", alignItems: "flex-start", width: width, height: "100vh", overflow: "hidden", boxShadow: "1px 0 2px rgba(0, 0, 0, 0.2)", backgroundColor: backgroundColor, color: contiamo_ui_utils_1.readableTextColor(backgroundColor)(["black", "white"]) }, hoverWidth);
};
