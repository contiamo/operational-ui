...
var SidebarItem = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(this.props.onClick && !this.state.open)) return [3 /*break*/, 2];
    ...
    SidebarItem.prototype.render = function () {
        ...
        /**
          ...
          own tooltips.
        */
        var HeaderWithTooltip = withTooltip_1.default(glamorous_1.Div);
        return (React.createElement("div", { className: this.props.className + " " + (this.state.updating ? "updating" : "") + " " + (this.state.open ? "open" : "") },
            React.createElement(HeaderWithTooltip, { className: "header " + (this.state.open ? "open" : ""), tooltip: this.props.tooltip, onClick: function () { return _this.toggle(); } }, this.props.label),
            this.state.open
