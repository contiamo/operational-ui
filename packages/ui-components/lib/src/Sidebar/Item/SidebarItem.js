...
var SidebarItem = /** @class */ (function (_super) {
    ...
    SidebarItem.prototype.render = function () {
        ...
        /**
          ...
          own tooltips.
        */
        return (React.createElement("div", { style: this.props.style, key: this.props.key, className: this.props.className + " " + (this.state.updating ? "updating" : "") + " " + (this.state.open ? "open" : "") },
