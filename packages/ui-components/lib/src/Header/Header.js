...
var Header = function (_a) {
    var className = _a.className, style = _a.style, children = _a.children, color = _a.color;
    return (React.createElement(Container, { style: style, className: className, color: color }, children));
};
