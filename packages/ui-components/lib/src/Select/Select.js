            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        this.setState(function () { return ({ updating: false, filter: filter }); });
                        return [2 /*return*/];
                }
            });
        });
    ...
    Select.prototype.render = function () {
        ...
        return (React.createElement("div", { ref: function (container) { return (_this.container = container); }, className: this.props.className + " Select" + (this.state.open ? " Select_open" : "") + (this.state.updating
            ...
            this.props.options.length && this.state.open
                ? React.createElement("div", { className: "Select__options" },
                    ...
                    React.createElement("div", { className: "Select__options_list" }, this.props.options.map(function (option) {
                        return option.label.match(_this.state.filter) &&
                            React.createElement(SelectOption_1.default, { key: option.id, onClick: function () { return _this.selectOption(option); }, selected: _this.isOptionSelected(option) }, option.label);
                    })))
                : ""));
    };
    Select.defaultProps = {
