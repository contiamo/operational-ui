...
var Progress = function (props) { return (React.createElement(Container, { id: props.id, css: props.css, className: props.className },
    ...
    props.error ? (React.createElement(ErrorMessage, null,
        ...
        props.onRetry && (React.createElement(Action, { onClick: props.onRetry },
            React.createElement(_1.Icon, { name: "RefreshCw" }),
