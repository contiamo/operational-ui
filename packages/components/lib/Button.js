...
var Container = glamorous_1.default.div(function (_a) {
    ...
    return __assign({ label: "button", display: "inline-block", padding: condensed ? spacing / 3 + "px " + spacing * 3 / 3 + "px" : spacing * 2 / 3 + "px " + spacing * 2 + "px", borderRadius: 2, cursor: disabled ? "auto" : "pointer", boxShadow: active ? activeBoxShadow : "none", backgroundColor: active ? activeBackgroundColor : backgroundColor, color: textColor, opacity: disabled ? 0.6 : 1.0, outline: "none" }, !disabled
        ? {
            ":hover": {
