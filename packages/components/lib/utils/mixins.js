...
exports.LabelText = glamorous_1.default.span(function (_a) {
    var theme = _a.theme;
    return (__assign({ display: "inline-block", verticalAlign: "middle", marginBottom: theme.spacing / 6, marginLeft: theme.spacing * 2 / 3 }, theme.typography.small, { fontWeight: 400, opacity: 0.4 }));
});
