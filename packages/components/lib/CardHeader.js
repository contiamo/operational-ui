...
var Container = glamorous_1.default.div(function (_a) {
    ...
    return (__assign({}, theme.typography.heading1, { label: "cardheader", display: "flex", alignItems: "center", 
        ...
        justifyContent: "space-between", height: 36, margin: theme.spacing * -1, marginBottom: theme.spacing * 4 / 3, padding: "0 " + theme.spacing + "px", borderBottom: "1px solid " + theme.colors.separator, fontWeight: 700, lineHeight: 1, color: theme.colors.emphasizedText }));
});
