...
exports.default = function (props) { return (React.createElement(Container, { key: props.id, css: props.css, className: props.className, clickable: !!props.onClick, onClick: props.onClick }, props.children)); };
