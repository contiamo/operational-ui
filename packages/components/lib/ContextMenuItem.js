...
var Container = glamorous_1.default.div(function (_a) {
    ...
    return (__assign({ label: "contextmenuitem", backgroundColor: theme.colors.white, minWidth: 160, width: "fit-content", padding: theme.spacing / 2 + "px " + theme.spacing + "px", border: "1px solid", borderColor: theme.colors.separator }, clickable
        ? {
            cursor: "pointer",
            "&:hover": {
