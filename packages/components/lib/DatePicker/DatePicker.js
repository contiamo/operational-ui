    ...
    DatePicker.prototype.render = function () {
        ...
        var datePickerWithoutLabel = (React.createElement(DatePicker_styles_1.Container, { innerRef: function (node) {
            ...
            !!(start && end) && (React.createElement(DatePicker_styles_1.Toggle, { onClick: function (ev) {
                ...
                React.createElement(_1.Icon, { name: "X", size: 14 }))),
            React.createElement(DatePicker_styles_1.Input, { isExpanded: this.state.isExpanded, id: domId, readOnly: true, innerRef: function (node) {
                ...
                }, value: [start, end].filter(function (s) { return !!s; }).join(" - "), placeholder: placeholder, onClick: function (ev) {
            ...
            React.createElement(DatePicker_styles_1.DatePickerCard, { isExpanded: isExpanded },
                React.createElement(DatePicker_styles_1.MonthNav, null,
                    React.createElement(DatePicker_styles_1.IconContainer, { onClick: function (ev) {
                        ...
                        React.createElement(_1.Icon, { name: "ChevronLeft", size: 14 })),
                    React.createElement("span", null, DatePicker_utils_1.months[month] + ", " + year),
                    React.createElement(DatePicker_styles_1.IconContainer, { onClick: function (ev) {
                            ev.preventDefault();
                            _this.changeMonth(+1);
                        } },
                        React.createElement(_1.Icon, { name: "ChevronRight", size: 14 }))),
