...
export const LabelText = glamorous.span(
  ({ theme }: { theme: Theme }): {} => ({
...
export const FormFieldControls = glamorous.div(
  ({ theme }: { theme: Theme }): {} => ({
    position: "absolute",
    top: 3,
    right: 0,
...
export const FormFieldControl = glamorous.div(
  ({ theme }: { theme: Theme }): {} => ({
    position: "relative",
    verticalAlign: "middle",
    display: "inline-block",
...
export const FormFieldError = glamorous.div(
  ({ theme }: { theme: Theme }): {} => ({
    ...theme.typography.small,
