      ...
      <Card>
        <Tree
          trees={itemsInSource.map(item => ({
            label: item,
            draggable: true,
            onDragStart: ev => setDragSource(item),
            onDragEnd: ev => setDragSource(undefined),
            tag: "C",
            childNodes: [],
          }))}
        />
        ...
        sections={
          <>
            ...
            <CardSection
              ...
              dragAndDropFeedback={dragSource ? (dropTarget === "container1" ? "dropping" : "validTarget") : undefined}
