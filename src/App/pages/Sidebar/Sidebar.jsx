...
export default () =>
  <div>
    ...
    <h2>
      The sidebar is a dynamic list-style navigational element to be used in
      cases with a large number of list-style actionable items.
    </h2>
    ...
    <h2>
      An expandable group of SidebarLinks, with added asynchronous
      functionality.
    </h2>
    ...
    <p style={{ marginTop: 16, marginBottom: 32 }}>
      <strong>
        ...
        <Link to="/tooltips">withTooltip</Link> and thus exposes all of the
