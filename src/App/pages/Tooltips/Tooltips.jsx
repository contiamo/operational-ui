...
export default () =>
  (<div>
    <h1>Tooltips</h1>
    <h2>
      These elements give helpful hints about actions an end-user can perform. They are designed to
      be reusable, elegant and unobtrusive.
    </h2>

    <p>
      Tooltips are great for UX. They can (and in many cases should) be used along with, and in,
      other components. For this reason, we took a highly versatile approach to our tooltips.
    </p>

    <h2>Usage</h2>
    <Playground codeText={snippet.tooltip} scope={{ React, Tooltip: StickyTooltip }} />
    ...
    <p>
      <strong>
        Note: The `color` and `anchor` props are still available, but prepended with the word
